...
- The `environment` section contains any [configuration variables](/self-hosted/config-options.html) we wish to set.
  ...
  - `ADMIN_EMAIL` and `ADMIN_PASSWORD` is the initial admin user credentials on first launch. You can remove admin user variables once you [persist the data](https://docs.directus.io/self-hosted/docker-guide.html#configure-admin-user).
